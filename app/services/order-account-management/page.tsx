...
export const metadata: Metadata = {
  title: "Order & Account Management | Velqa Technologies LLC",
  description: "End-to-end order tracking, account management, and returns processing services.",
}
...
const features = [
  ...
  },
  {
    ...
    description: "Dedicated account management services ensuring customer accounts are maintained accurately and efficiently.",
  },
  {
...
const relatedServices = [
  ...
  { title: "Back-Office Operations", href: "/services/back-office-operations" },
]

export default function OrderAccountManagementPage() {
  return (
    <ServicePageTemplate
      icon={Package}
      title="Order & Account Management"
      subtitle="Fulfillment Support"
      description="Comprehensive order and account management services that streamline your fulfillment operations. From order tracking to returns processing, we ensure smooth customer experiences throughout the purchase journey."
      features={features}
      benefits={benefits}
